...
protected:
	...
	virtual void writeSuccessLog(const fastcgi::Logger::Level level, const char* strInput, const char* strOutput, std::string strDes);

	virtual void writeErrorLog(const fastcgi::Logger::Level level, int nErrCode, const char* strInput, std::string strDes);
