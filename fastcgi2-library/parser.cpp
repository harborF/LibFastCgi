...
namespace fastcgi
{
    ...
    void Parser::addCookie(RequestImpl *req, const Range &range) {
    ...
    void Parser::addHeader(RequestImpl *req, const Range &key, const Range &value) {
        req->headers_[normalizeInputHeaderName(key)] = value.toString();
    }

    void Parser::parse(RequestImpl *req, char *env[], Logger* logger) {
    ...
    void Parser::parseCookies(RequestImpl *req, const Range &range) {
    ...
    void Parser::parseLine(DataBuffer line, DataBuffer &name, DataBuffer &filename, DataBuffer &type) {
        while (!line.empty()) {
    ...
    void Parser::parsePart(RequestImpl *req, DataBuffer part) {
    ...
    void Parser::parseMultipart(RequestImpl *req, DataBuffer data, const std::string &boundary) {
    ...
    std::string Parser::normalizeInputHeaderName(const Range &range) {
    ...
    std::string Parser::normalizeOutputHeaderName(const std::string &name) {
