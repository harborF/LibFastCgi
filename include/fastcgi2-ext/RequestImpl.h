...
#include "fastcgi2-ext/functors.h"
...
namespace fastcgi
{
    ...
    class RequestImpl : private noncopyable {
    public:
    ...
    private:
        ...
        uint64_t serializeEnv(DataBuffer &buffer, uint64_t add_size);
        uint64_t serializeInt(DataBuffer &buffer, uint64_t pos, uint64_t val);
        uint64_t serializeString(DataBuffer &buffer, uint64_t pos, const std::string &val);
        uint64_t serializeBuffer(DataBuffer &buffer, uint64_t pos, const DataBuffer &src);
        uint64_t serializeFiles(DataBuffer &buffer, uint64_t pos);
        uint64_t serializeArgs(DataBuffer &buffer, uint64_t pos);

        uint64_t parseInt(DataBuffer buffer, uint64_t pos, uint64_t &val);
        uint64_t parseString(DataBuffer buffer, uint64_t pos, std::string &val);
        uint64_t parseHeaders(DataBuffer buffer, uint64_t pos);
        uint64_t parseCookies(DataBuffer buffer, uint64_t pos);
        uint64_t parseVars(DataBuffer buffer, uint64_t pos);
        uint64_t parseBody(DataBuffer buffer, uint64_t pos);
        uint64_t parseFiles(DataBuffer buffer, uint64_t pos);
        uint64_t parseArgs(DataBuffer buffer, uint64_t pos);

        uint64_t bodySerializedSize();
        uint64_t filesSerializedSize();
        uint64_t argsSerializedSize();
